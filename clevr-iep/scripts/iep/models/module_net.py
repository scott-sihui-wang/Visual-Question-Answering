...
class ModuleNet(nn.Module):
  ...
  def forward(self, x, program):
    #print("program:",program,"type:",type(program),"dim:",program.dim())
    #print(type(program.detach().cpu().numpy()))
    #if type(program) is Variable:
    #	print("OK")
