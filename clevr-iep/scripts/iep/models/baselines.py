...
class StackedAttention(nn.Module):
  ...
  def forward(self, v, u):
    ...
    #print("p:",p,"shape:",p.size())
    #print("v:",v,"shape:",v.size())
    #print("N:",N)
    #print("D:",D)
    #test=p.expand_as(v)
    #print("p_expand_as_v:",test,"shape:",test.size())
    #print(test*v,(test*v).size())
    v_tilde = (p.expand_as(v) * v).sum(2).sum(2).view(N, D) #original code here sum(3) is wrong
    next_u = u + v_tilde
    return next_u
