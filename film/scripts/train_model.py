...
# Input data
parser.add_argument('--train_question_h5', default='../clevr-iep/data/train_questions.h5')
parser.add_argument('--train_features_h5', default='../clevr-iep/data/train_features.h5')
parser.add_argument('--val_question_h5', default='../clevr-iep/data/val_questions.h5')
parser.add_argument('--val_features_h5', default='../clevr-iep/data/val_features.h5')
parser.add_argument('--feature_dim', default='1024,14,14')
parser.add_argument('--vocab_json', default='../clevr-iep/data/vocab.json')
